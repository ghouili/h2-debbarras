...
export const designTokens = {
  ...
  button: {
    ...
    primary:
      "bg-gradient-to-r from-primary-600 via-primary-400 to-primary-300 text-primary-foreground hover:from-primary-700 hover:via-primary-500 hover:to-primary-400 shadow-lg shadow-primary/30 transition-all duration-200 hover:shadow-xl hover:shadow-primary/40 hover:-translate-y-0.5",
    // Solid primary (Royal Blue)
    primarySolid:
      "bg-primary text-primary-foreground hover:bg-primary-700 shadow-lg shadow-primary/25 transition-all duration-200 hover:shadow-xl hover:shadow-primary/35 hover:-translate-y-0.5",
  ...
  typography: {
    ...
    lead: "text-lg md:text-xl lg:text-2xl text-muted-foreground",
